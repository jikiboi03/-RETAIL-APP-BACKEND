...
$route['showlist-stock-adjustment/(:num)'] = 'Prod_details/Prod_details_controller/ajax_list/$1';

$route['add-stock-adjustment'] = 'Prod_details/Prod_details_controller/ajax_add';
